...
from .bert_bmes_lexicon_pinyin_encoder import BERT_BMES_Lexicon_PinYin_Word_Attention_Cat_Encoder, BERT_BMES_Lexicon_PinYin_Word_Attention_Add_Encoder
from .bert_bmes_lexicon_pinyin_encoder import BERT_BMES_Lexicon_PinYin_Char_Attention_Cat_Encoder, BERT_BMES_Lexicon_PinYin_Char_Attention_Add_Encoder
