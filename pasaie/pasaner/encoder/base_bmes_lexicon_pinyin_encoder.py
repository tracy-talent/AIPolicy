...
class BASE_BMES_Lexicon_PinYin_Word_Cat_Encoder(nn.Module):
    def __init__(self, 
                token2id,
                word2id,
                pinyin2id,
        ...
        """
        super(BASE_BMES_Lexicon_PinYin_Word_Cat_Encoder, self).__init__()
    ...
    def forward(self, seqs_token_ids, seqs_lexicon_embed, seqs_pinyin_ids, seqs_lexicon_bmes_ids, att_lexicon_mask, att_token_mask):
        ...
        inputs_embed = torch.cat([token_seqs_embed, bmes_one_hot_embed, seqs_lexicon_embed, seqs_pinyin_embed], dim=-1)
...
class BASE_BMES_Lexicon_PinYin_Char_Cat_Encoder(nn.Module):
    def __init__(self, 
                token2id,
                word2id,
                pinyin_char2id,
        ...
        Args:
            ...
            blank_padding (bool, optional): whether pad sequence to max length. Defaults to True.
        """
        super(BASE_BMES_Lexicon_PinYin_Char_Cat_Encoder, self).__init__()
    ...
    def forward(self, seqs_token_ids, seqs_lexicon_embed, seqs_pinyin_char_ids, seqs_lexicon_bmes_ids, att_pinyin_char_mask, att_lexicon_mask, att_token_mask):
        ...
        inputs_embed = torch.cat([token_seqs_embed, bmes_one_hot_embed, seqs_lexicon_embed, pinyin_conv], dim=-1)
...
class BASE_BMES_Lexicon_PinYin_Char_MultiConv_Cat_Encoder(BASE_BMES_Lexicon_PinYin_Char_Cat_Encoder):
    def __init__(self, 
                token2id,
                word2id,
                pinyin_char2id,
