"""
 Author: liujian
 Date: 2021-02-28 21:23:16
 Last Modified by: liujian
 Last Modified time: 2021-02-28 21:23:16
"""
...
if args.encoder_type == 'entity_dist':
    sentence_encoder = pasare.encoder.XLNetEntityDistEncoder(
    ...
    sentence_encoder = pasare.encoder.XLNetEntityDistWithPCNNEncoder(
        max_length=args.max_length,
        position_size=args.position_size,
        pretrain_path=args.pretrain_path,
        tag2id=tag2id,
    ...
    sentence_encoder = pasare.encoder.XLNetEntityDistWithContextEncoder(
        max_length=args.max_length,
        position_size=args.position_size,
        pretrain_path=args.pretrain_path,
        tag2id=tag2id,
...
logger.info('({}, {}, {}, dpr{:.1f})Micro F1: {}'.format(args.dataset, 'xlnet', args.encoder_type, args.dropout_rate, result['micro_f1']))
