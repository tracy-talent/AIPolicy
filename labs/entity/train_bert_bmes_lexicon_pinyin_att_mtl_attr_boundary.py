...
def make_dataset_name():
    ...
    return dataset_name
def make_model_name():
    model_name = f'bmes{args.group_num}_lexicon_{lexicon_name}_window{args.lexicon_window_size}_pinyin_{args.pinyin_embedding_type}_attn_mtl_attr_boundary_bert'
    if args.use_lstm:
        model_name += '_lstm'
