...
parser.add_argument('--embedding_fusion_type', default='att_add', type=str, choices=['att_cat', 'att_add'],  
...
def make_model_name():
    if args.model_type == 'startprior':
        model_name = f'bmes{args.group_num}_lexicon_{lexicon_name}_window{args.lexicon_window_size}_attn_mtl_span_attr_boundary_startprior_bert'
    elif args.model_type == 'attention':
        model_name = f'bmes{args.group_num}_lexicon_{lexicon_name}_window{args.lexicon_window_size}_attn_mtl_span_attr_boundary_attention_bert'
    elif args.model_type == 'mmoe':
        model_name = f'bmes{args.group_num}_lexicon_{lexicon_name}_window{args.lexicon_window_size}_attn_mtl_span_attr_boundary_mmoe_bert'
    elif args.model_type == 'ple':
        model_name = f'bmes{args.group_num}_lexicon_{lexicon_name}_window{args.lexicon_window_size}_attn_mtl_span_attr_boundary_ple_bert'
    elif args.model_type == 'plethree':
        model_name = f'bmes{args.group_num}_lexicon_{lexicon_name}_window{args.lexicon_window_size}_attn_mtl_span_attr_three_boundary_ple_bert'
    elif args.model_type == 'pletogether':
        model_name = f'bmes{args.group_num}_lexicon_{lexicon_name}_window{args.lexicon_window_size}attn__mtl_span_attr_boundary_together_ple_bert'
    elif args.model_type == 'plerand':
        model_name = f'bmes{args.group_num}_lexicon_{lexicon_name}_window{args.lexicon_window_size}_attn_mtl_span_attr_boundary_plerand_bert'
    elif args.model_type == 'plecat':
        model_name = f'bmes{args.group_num}_lexicon_{lexicon_name}_window{args.lexicon_window_size}_attn_mtl_span_attr_boundary_plecat_bert'
    else:
        model_name = f'bmes{args.group_num}_lexicon_{lexicon_name}_window{args.lexicon_window_size}_attn_mtl_span_attr_boundary_bert'
    # model_name += '_noact'
    # model_name += '_drop_ln'
    # model_name += '_drop'
...
if args.embedding_fusion_type == 'att_cat':
    sequence_encoder = pasaner.encoder.BERT_BMES_Lexicon_Attention_Cat_Encoder(
...
elif args.embedding_fusion_type == 'att_add':
    sequence_encoder = pasaner.encoder.BERT_BMES_Lexicon_Attention_Add_Encoder(
        pretrain_path=args.pretrain_path,
        word2id=word2id,
        word_size=word2vec.shape[-1],
        lexicon_window_size=args.lexicon_window_size,
    ...
    raise NotImplementedError(f'args.embedding_fusion_type: {args.embedding_fusion_type} is not supported by exsited model currently.')
