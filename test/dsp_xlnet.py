...
if __name__ == '__main__':
    ...
    # pretrain_path = '/home/liujian/NLP/corpus/transformers/hfl-chinese-xlnet-base' # zh
    # pretrain_path = '/home/liujian/NLP/corpus/transformers/hfl-chinese-xlnet-large' # zh
    # pretrain_path = '/home/liujian/NLP/corpus/transformers/xlnet-base-cased' # en
    pretrain_path = '/home/liujian/NLP/corpus/transformers/xlnet-large-cased' # en
    ...
    # construct_corpus_dsp_with_xlnet(corpus_path=semeval_path, pretrain_path=pretrain_path, dsp_tool='stanza', language='en')
    ...
    construct_corpus_dsp_with_xlnet(corpus_path=kbp37_path, pretrain_path=pretrain_path, dsp_tool='stanza', language='en')
